...
def process_frame(frame):
    ...
    if with_nmsup is False:
        ...
        cv2.waitKey(1)  # Adjust the delay (1ms) as needed

    # or apply non-maximal suppression
    else:
...
# Open video capture
cap = cv2.VideoCapture(1)  # Replace 0 with the appropriate camera index if multiple cameras are available
